...
/**
 * Created by bigggfish on 2016/11/25.
 * description:
 */
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                break;
            case MotionEvent.ACTION_UP:
                Log.e(TAG, "MotionEvent.ACTION_UP  mIsBeingDragged:" + mIsBeingDragged);
                //if (mIsBeingDragged) {
                    ...
                    int initialVelocity = (int) VelocityTrackerCompat.getYVelocity(velocityTracker,
                            mActivePointerId);
                    Log.e(TAG, "initialVelocity" + initialVelocity + "mMinimumVelocity:" + mMinimumVelocity);
